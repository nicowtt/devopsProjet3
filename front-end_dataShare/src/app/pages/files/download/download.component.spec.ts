...
import { LUCIDE_ICONS, LucideIconProvider, File as FileIcon, FileImage, FileMusic, FilePlay, Lock, Eye, EyeOff, Info, TriangleAlert, CloudDownload } from 'lucide-angular';
...
describe('DownloadComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        provideToastr(),
        { provide: LUCIDE_ICONS, useValue: new LucideIconProvider({ File: FileIcon, FileImage, FileMusic, FilePlay, Lock, Eye, EyeOff, Info, TriangleAlert, CloudDownload }), multi: true },
